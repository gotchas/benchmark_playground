...
#define TO_UNSIGNED_LOW(x)                                                                            \
   (__builtin_choose_expr(                                                                            \
       sizeof(x) <= sizeof(int), (unsigned)(x),                                                       \
...
extern "C" int __absvsi2(int a) {
   TRACE(a);
   return a < 0 ? -a : a;
}
extern "C" long __absvdi2(long a) {
   TRACE(a);
   return a < 0 ? -a : a;
}
...
extern "C" int __addvsi3(int a, int b) {
   TRACE2(a, b);
   if (is_add_overflow(a, b, 0)) ++int_add_overflow;
   return a + b;
}
extern "C" long __addvdi3(long a, long b) {
   TRACE2(a, b);
...
extern "C" int __mulvsi3(int a, int b) {
   TRACE2(a, b);
   return a * b;
}
extern "C" long __mulvdi3(long a, long b) {
   TRACE2(a, b);
   return a * b;
}
// The functions return the product of a and b; that is a * b.

extern "C" int __negvsi2(int a) {
   TRACE(a);
   return -a;
}
extern "C" long __negvdi2(long a) {
   TRACE(a);
   return -a;
}
...
extern "C" int __subvsi3(int a, int b) {
   TRACE2(a, b);
   if (is_subtract_overflow(a, b, 0)) ++subtract_overflow;
   return a - b;
}
extern "C" long __subvdi3(long a, long b) {
   TRACE2(a, b);
   if (is_subtract_overflow(a, b, 0)) ++subtract_overflow;
   return a - b;
}
